                                ...
                                children: [
                                  Column(
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=>const SegmentView(isAdmin: false, segment: 'App Development', photo: 'assets/images/app.png')));
                                        },
                                  ...
                                  InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>const SegmentView(isAdmin: false, segment: 'Competitive Programming', photo: 'assets/images/cp.jpg')));
                                    },
                                    child: const Column(
                                      children: [
                                        CircleAvatar(
                                  ...
                                  InkWell(
                                    onTap: (){
                                      Navigator.push(context, MaterialPageRoute(builder: (context)=>const SegmentView(isAdmin: false, segment: 'Cyber Security', photo: 'assets/images/cyber.jpg')));
                                    },
                                    child: const Column(
                                      children: [
                                        Gap(120),
                                ...
                                children: [
                                  Column(
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=>const SegmentView(isAdmin: false, segment: 'Web Development', photo: 'assets/images/web.jpg')));
                                        },
                                        child: CircleAvatar(
                                          radius: 35,
                                          backgroundColor: white,
                                  ...
                                  Column(
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context)=>const SegmentView(isAdmin: false, segment: 'Graphic Design', photo: 'assets/images/GRAPHICS.jpeg')));
                                        },
                                        child: CircleAvatar(
                                          radius: 35,
                                          backgroundColor: white,
